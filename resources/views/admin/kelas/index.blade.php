                ...
                <div class="mx-3 my-2">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-3 d-flex align-self-end">
                            ...
                            <a href="/admin/kelas" class="btn btn-danger ms-2">Reset</a>
                        </div>
                        <div class="col-md-3 text-end  align-self-end">
                            <a href="/admin/kelas/create" type="button" class="btn btn-primary"><i
                        ...
                        <tbody>
                            @foreach ($data_kelas as $kelas)
                                <tr>
                                    ...
                                    <td class="px-4">
                                        <a href="/admin/kelas/{{ $kelas->id }}">
                                            <span class="badge bg-gradient-success" title="Lihat Detail">
                                                <i class="fas fa-eye "></i>
                                            </span>
                                        </a>
                                        <a href="/admin/kelas/{{ $kelas->id }}/edit">
